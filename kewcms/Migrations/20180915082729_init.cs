        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallIndex = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplayContent = table.Column<string>(nullable: true),
                    ReplayTime = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoKeyword = table.Column<string>(nullable: true),
                    SeoDescription = table.Column<string>(nullable: true),
                    Click = table.Column<int>(nullable: true),
